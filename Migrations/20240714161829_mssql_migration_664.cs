...
{
    /// <inheritdoc />
    public partial class mssql_migration_664 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PrimeiroNome = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    UltimoNome = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    DataCriacao = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Deleted = table.Column<bool>(type: "bit", nullable: false),
                    CriadoPorOid = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CriadoPorUsername = table.Column<string>(type: "nvarchar(max)", nullable: true),
